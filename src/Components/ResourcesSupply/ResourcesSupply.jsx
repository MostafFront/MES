...
const buttonData = {
    today: {
        production: 7200,
        productionSupply: 5500,
        productionRange: 70,
    },
    yesterday: {
        production: 6100,
        productionSupply: 4900,
        productionRange: 75,
    },
    lastWeek: {
        production: 38000,
        productionSupply: 6200,
        productionRange: 85,
    },
};
...
const supplierData = {
    today: [
        { supplierName: 'ABC Supplies', supplierCode: 'SUP001', lastMaterial: 'Aluminum', lastOrderDateTime: '09:00 | 10-15-2024' },
        { supplierName: 'XYZ Corp', supplierCode: 'SUP002', lastMaterial: 'Steel', lastOrderDateTime: '11:30 | 10-15-2024' },
    ],
    yesterday: [
        { supplierName: 'LMN Industries', supplierCode: 'SUP003', lastMaterial: 'Copper', lastOrderDateTime: '14:45 | 10-14-2024' },
        { supplierName: 'PQR Ltd.', supplierCode: 'SUP004', lastMaterial: 'Plastic', lastOrderDateTime: '16:15 | 10-14-2024' },
    ],
    lastWeek: [
        { supplierName: 'EFG Trading', supplierCode: 'SUP005', lastMaterial: 'Wood', lastOrderDateTime: '09:30 | 10-08-2024' },
        { supplierName: 'HIJ Supplies', supplierCode: 'SUP006', lastMaterial: 'Concrete', lastOrderDateTime: '10:00 | 10-09-2024' },
    ],
};
...
const alertsData = {
    ...
    yesterday: [
        ...
        },
        {
            ...
            icon: 'fa-rocket',
            type: 'Machine',
            description: 'Machine maintenance alert',
        },
    ],
    lastWeek: [
        {
        ...
        },
        {
            ...
            icon: 'fa-rocket',
            type: 'Machine',
            description: 'Machine recalibration required',
        },
    ],
};
...
export default function ResourcesSupply() {
    ...
    const filteredData = supplierData[activeButton].filter(item =>
                        ...
                        <div className='flex items-start justify-between h-auto gap-5 w-full'>
                            <div className='flex flex-col items-center justify-start h-full gap-y-10 w-[90%] '>
                                <div className='w-full flex items-start justify-between min-h-[5%]'>
                                    <p className=' font-medium text-[#003F5C]'>Resources \ Materials \ Supply</p>
                                    ...
                                    <div className='flex justify-between items-center border-b border-[#EFEFEF] w-full '>
                                        ...
                                        <div className='flex justify-center items-center gap-10 pr-20 w-[50%]'>
                                            ...
                                            <div className='flex gap-5'>
                                                <i class="fa-solid items-center fa-braille text-[#8D9192] text-sm"></i>
                                                <p className='font-medium text-[#8D9192] text-xs'>Material Supply</p>
                                            </div>
                                        </div>
                                    </div>
